...
dropbox_yml = File.expand_path('../../config/dropbox.yml',  __FILE__)
...
Backup::Model.new(:db_backup, "Backup paperclip data and database") do
  ...
  notify_by Mail do |mail|
    ...
    mail.from                 = 'backup@textcaptcha.ir'
